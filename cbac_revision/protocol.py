...
def validate_protocol(protocol: Mapping[str, Any]) -> None:
    ...
    if (
        ...
        or adamson_evidence.get("exact_archived_labels") != list(adamson_expected_counts)
        or adamson_evidence.get("exact_archived_label_counts") != adamson_expected_counts
        or adamson_evidence.get("expected_control_cell_count") != 6012
        or sum(adamson_expected_counts.values())
        != adamson_evidence.get("expected_control_cell_count")
    ...
    if (
        ...
        or measured.get("production_execution_device") != "cuda"
        or measured.get("minimum_accelerator_count_per_successful_fit") != 1
        or measured.get("required_peak_memory_status") != "MEASURED_CUDA_MAX_MEMORY_ALLOCATED"
        or measured.get("cpu_execution_release_policy") != "WITHHELD_FIXTURE_OR_PREFLIGHT_ONLY"
    ):
    ...
    if (
        ...
        or external.get("pinned_git_tree_sha1") != "d9d557b0e91602317c1bb5d3960827f80052d343"
        or external.get("official_metric_source") != "gears/inference.py"
        or external.get("official_metric_source_git_blob_sha1")
        != "9289522b720d7c53e29519bee0ef227ad7e06406"
        or external.get("official_metric_source_sha256")
        != "744668b54fa05c0493baefad3da6fdccfa658426db5d0519b27a2d3f4f036dd7"
        or external.get("official_metric_source_bytes") != 33564
        or external.get("official_model_source") != "gears/gears.py"
        or external.get("official_model_source_git_blob_sha1")
        != "49d4d94fc5bd038231d606df461591c526d6d8d3"
        or external.get("official_model_source_sha256")
        != "b87b464b9bce74ff909626ef642781c5b8df6907902c5e18ec11d6c57ca7f562"
        or external.get("official_model_source_bytes") != 26531
    ...
    if (
        ...
        or external_family.get("canonical_official_repositories")
        != {
            "GEARS": "https://github.com/snap-stanford/GEARS",
            "scGPT": "https://github.com/bowang-lab/scGPT",
            "Geneformer": "https://huggingface.co/ctheodoris/Geneformer",
        }
        or external_family.get("repository_url_normalization")
        != "strip_one_trailing_slash_and_optional_dot_git_only"
        ...
        != [
            ...
            "execution_output_manifest",
        ]
        or external_family.get("detached_pre_execution_anchor")
        != {
            "caller_pinned_sha256_required": True,
            "must_be_frozen_before_any_comparator_execution": True,
            "pre_contract_outcome_hashes": "PROHIBITED",
            "post_audit_must_bind_pre_contract": True,
            "performance_contract_count_per_validated_member": 12,
            "performance_execution_registry_required_for_PASS": True,
            "synchronized_posthoc_pre_anchor_rewrite_decision": "WITHHELD",
        }
