    ...
    *,
    ...
    locks["PRIMARY-DECISION"] = analysis_lock(
        ...
        primary,
        {
            ...
            "topology_registry_hash": topology.registry.get(
                "analysis_registry_hash", canonical_sha256(topology.registry)
            ),
    ...
    if mixed_support.released:
        ...
        secondary_payload["claim_consequence_registry_hash"] = consequence_hash
        secondary_payload["claim_consequence_registry"] = dict(claim_consequence_registry)
        secondary_payload["baseline_gate_records_sha256"] = claim_consequence_registry.get(
            "baseline_gate_records_sha256"
        )
        secondary_payload["ranking_gate_records_sha256"] = claim_consequence_registry.get(
            "ranking_gate_records_sha256"
        )
        secondary_payload["release_asset_manifest_file_sha256"] = claim_consequence_registry.get(
            "release_asset_manifest_file_sha256"
        )
        secondary_payload["release_asset_manifest_self_hash"] = claim_consequence_registry.get(
